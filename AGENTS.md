...
- Obtain adversarial design review before implementation and independent code review before every merge. The planner merges unless the active workflow explicitly names another merger.
