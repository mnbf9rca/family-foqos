...
final class ScreenshotDemoModeTests: XCTestCase {
  ...
  func testGivenScenarioRawValues_WhenParsing_ThenAllFiveResolve() {
    ...
    XCTAssertEqual(ScreenshotDemoScenario(rawValue: "location-restrictions"), .locationRestrictions)
  }
}
